...
public class UserRegisterNotValidatedMailObject implements MailObject {
	...
	public UserRegisterNotValidatedMailObject( String login,  String email, List<Grid> gridList, String baseUrl)
	{
		this.login = login;
	...
	public String toHtml()
	{
		...
		result.append( "                <p>You've just signed up on Instantri.ch. You already can buy credits and start to play.</p>");
		result.append( "                <p>Unfortunately, we cannot trust the email address you used when registering so we cannot allow you to play in our free games. Maybe your are using a temporary/disposable email service. You can buy credits and open boxes as everyone else though.</p>");
	...
	public String toText()
	{
		...
		result.append( "Hi " + login + ". You've just signed up on Instantri.ch. You already can buy credits and start to play.\r\n");
		result.append( "Unfortunately, we cannot trust the email address you used when registering so we cannot allow you to play in our free games. Maybe your are using a temporary/disposable email service.\r\n.");
		result.append( "You can buy credits and open boxes as everyone else though.\r\n.");
