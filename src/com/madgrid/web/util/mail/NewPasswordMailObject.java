...
public class NewPasswordMailObject implements MailObject {
	...
	public String toHtml()
	{
		...
		result.append( "				<p>You have request a new password for Instantri.ch. Click on the link below to reset your password</p>");
		result.append( "				<p><a href='"+baseUrl+"/do/passwordReset?login="+login+"&email="+email+"&code="+code+"'>Reset password</a></p>");
		result.append( "				<p>You have 24 hours to change it. If you don't click on the link before 24 hours the password will remain as is now. If you haven't requested a password reseting, please ignore this message.</p>" );
	...
	public String toText()
	{
		...
		result.append( login + ". You have request a new password for Instantri.ch. Click on the link below to reset your password:\r\n");
		result.append( baseUrl+"/do/resetPassword?login="+login+"&email="+email+"&code="+code);
		result.append( "You have 24 hours to change it. If you don't click on the link before 24 hours the password will remain as is now. <br/> If you haven't requested a password reseting, please ignore this message.\r\n" );
