...
public class SendValidationMailObject implements MailObject {
	...
	public SendValidationMailObject( String login,  String email,  String code, String baseUrl)
	{
		this.login = login;
	...
	public String toHtml()
	{
		...
		result.append( "				<p>You have asked us to send you the email with the validation link again. Click on this link to validate your email address so you can play in our free games or buy credits to play in any game.</p>");
		result.append( "				<p><a href='"+baseUrl+"/do/validateEmail?email="+email+"&user="+login+"&code="+code+"'>Validate email account</a></p>");
	...
	public String toText()
	{
		...
		result.append( "Hi " + login + ". You have asked us to send you the email with the validation link again.\r\n");
		result.append( "Click on this link to validate your email address so you can play in our free games or buy credits to play in any game.\r\n.");
