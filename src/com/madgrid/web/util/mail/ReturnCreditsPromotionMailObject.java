...
public class ReturnCreditsPromotionMailObject implements MailObject {

	private String 	login;
	private String 	baseUrl;
	private Integer credits;
	
	public ReturnCreditsPromotionMailObject( String login, Integer credits, String baseUrl)
	{
		this.login = login;
	...
	public String toHtml()
	{
		...
		result.append( "				<p>You've got a refund of the " + credits + " Instantri.ch credits which you used in a game with no winners.</p>");
	...
	public String toText()
	{
		...
		result.append( "You've got a refund of the " + credits + " Instantri.ch credits which you used in a game with no winners.\r\n");
